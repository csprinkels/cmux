...
final class MobileWorkspaceListObserver {
    ...
    private let workspaceUpdateEmitter: @MainActor (_ summaryHash: Int) -> Void
    ...
    init(
        ...
        workspaceUpdateEmitter: (@MainActor (_ summaryHash: Int) -> Void)? = nil
    ) {
        self.tabManager = tabManager
        self.notificationStore = notificationStore
        self.workspaceUpdateEmitter = workspaceUpdateEmitter ?? { _ in
